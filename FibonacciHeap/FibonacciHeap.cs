...
namespace Heap
{
    ...
    public class FibonacciHeap<T, TKey> where TKey : IComparable<TKey>
    {
        ...
        public FibonacciHeap(FibonacciHeapNode<T, TKey> node)
        {
            _minNode = node;
            _nNodes++;
        }

        public FibonacciHeap(T data, TKey key)
        {
            _minNode = new FibonacciHeapNode<T, TKey>(data, key);
            _nNodes++;
        }
        ...
        /// O(1)
        /// </summary>
        public FibonacciHeapNode<T, TKey> Insert(FibonacciHeapNode<T, TKey> node)
        {
        ...
        /// <summary>
        /// Create and Inserts a new node with its key.
        /// O(1)
        /// </summary>
        public FibonacciHeapNode<T, TKey> Insert(T data, TKey key)
        {
            return Insert(new FibonacciHeapNode<T, TKey>(data, key));
        }

        /// <summary>
        /// Removes the smallest node of the heap.
        /// O(log n) amortized
        /// </summary>
        /// <returns></returns>
